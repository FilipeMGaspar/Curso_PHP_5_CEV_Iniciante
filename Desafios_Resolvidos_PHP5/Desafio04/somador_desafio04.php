        ...
        <?php
            ...
            if (($val=="nd") || ($val2=="nd") || ($val1=="") || ($val2=="")){
                ...
                if($soma>20){
                    ...
                    echo "<br>O resultado da soma é <span class='foco'>$soma</span> que é menor ou igual a 20.<br> Por isso vamos subtrair 3."; 
                    $soma -= 3;
                    echo "<br><br><h3>Valor da subtração condicional <span class='foco'>$soma</span></h3>";
                }
            }    
        ?>
